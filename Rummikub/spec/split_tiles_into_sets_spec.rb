...
RSpec.describe SplitTilesIntoSets do
  ...
  #       {"id"=>158, "colour"=>Tile::BLACK, "number"=>1, "player_id"=>nil, "on_board"=>true, "x"=>2, "y"=>0},
  #       {"id"=>115, "colour"=>Tile::BLUE, "number"=>1, "player_id"=>nil, "on_board"=>true, "x"=>3, "y"=>0},
  #       {"id"=>105, "colour"=>Tile::RED, "number"=>11, "player_id"=>1, "on_board"=>true, "x"=>4, "y"=>3},
  #       {"id"=>158, "colour"=>Tile::RED, "number"=>12, "player_id"=>nil, "on_board"=>true, "x"=>5, "y"=>3},
  #       {"id"=>115, "colour"=>Tile::RED, "number"=>13, "player_id"=>nil, "on_board"=>true, "x"=>6, "y"=>3}]
  #     split_tiles = SplitTilesIntoSets.new(tiles)
  #     expect(split_tiles.call.length).to eql 2
  #   end
  # end
  ...
  #       {"id"=>105, "colour"=>Tile::RED, "number"=>11, "player_id"=>1, "on_board"=>true, "x"=>6, "y"=>3},
  #       {"id"=>158, "colour"=>Tile::RED, "number"=>12, "player_id"=>nil, "on_board"=>true, "x"=>7, "y"=>3},
  #       {"id"=>115, "colour"=>Tile::RED, "number"=>13, "player_id"=>nil, "on_board"=>true, "x"=>8, "y"=>3}]
  #     split_tiles = SplitTilesIntoSets.new(tiles)
  #     expect(split_tiles.call.length).to eql 2
  #   end
  # end
